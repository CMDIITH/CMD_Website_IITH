  ...
  return (
    <div className='phases-all'>
      <div className='phases-masterplan'>
        ...
        <img className='phases-masterplan-map' src={master_plan} alt="yoo" />
      </div>
      <div className='phases-phase-1'>
        <h1 className='phases-phase-1-heading'>PHASE-1</h1>
        <div class="phases-phase-1-grid">
          <img src={phase1_1} className="img5" />
          <img src={phase1_2} className="img5" />
          <img src={phase1_3} className="img5" />
          <img src={phase1_4} className="img4" />
          <img src={phase1_5} className="spanrow" />
          <img src={phase1_6} className="img5" />
          <img src={phase1_7} className="img5" />
        </div>
      ...
      <div className='phases-phase-1'>
        ...
        <div class="phases-phase-1-grid">
          <img src={phase2_2} className="img5" />
          <img src={phase2_3} className="img5" />
          <img src={phase2_5} className="img5" />
          <img src={phase2_4} className="img4" />
          <img src={phase2_1} className="spanrow" />
          <img src={phase2_6} className="img5" />
          <img src={phase2_7} className="img5" />
        </div>
      ...
      <div className='phases-phase-1 phases-phase-3'>
        ...
        <div class="phases-phase-1-grid">
          <img src={phase3_1} className="img5" />
          <img src={phase3_4} className="img5" />
          <img src={phase3_3} className="img5" />
          <img src={phase3_2} className="img4" />
          <img src={phase3_5} className="spanrow" />
          <img src={phase3_6} className="img5" />
          <img src={phase3_7} className="img5" />
        </div>
      ...
      <div className='phases-phase-1 future-plans-all'>
        ...
        <img className='phases-masterplan-map phases-future-plan-img' src={future1} alt="yoo" />
